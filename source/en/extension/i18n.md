...
You can use i18n in `package.json` when register menu path, just use the format `i18n:${key}`. We can write: `i18n:MAIN_MENU.package/foobar/i18n:foobar.edit`, Cocos Creator will help use replace the i18n text.
