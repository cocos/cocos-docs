...
The currently supported tags are: color, size, b, i, u, br and on, these tags could also be nested.
...
## BBCode format
### Basics
Currently the supported tag list is: size, color, b, i, u and on. There are used for customizing the font size, font color, bold, italic, underline and click event.
