...
<td style="padding:4px;border:1px solid black">
    ...
    在这个时间里我们可以定制我们想要的行为，<b>onPreSolve</b> 和 <b>onPostSolve</b> 会在时间步内被重复调用，这给了我们
    在物理引擎处理碰撞信息前(<b>onPreSolve</b>)修改碰撞信息 或者 物理引擎计算出碰撞的冲量后(<b>onPostSolve</b>) 获取冲量信息的机会。<br>
