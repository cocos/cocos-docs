...
具体内容可参考 [官方范例](https://github.com/cocos-creator/example-cases/tree/v2.4.3/assets/cases/07_capture_texture) 中 **07_capture_texture** 关于三种不同平台如何截屏并保存的测试例。
...
具体内容可参考 [官方范例](https://github.com/cocos-creator/example-cases/tree/v2.4.3/assets/cases/dragonbones) 中的 **dragonBones/DragonMesh** 测试例。
...
具体内容可参考官方范例中的 [custom_material](https://github.com/cocos-creator/example-cases/tree/v2.4.3/assets/cases/06_rendering/custom_material) 测试例。
