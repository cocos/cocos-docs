...
布局的组件接口请参考 [Layout API](__APIDOC__/zh/#/docs/3.5/zh/ui/Class/Layout)。

具体使用方法可参考范例 **Layout**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/05.layout) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/05.layout)）。
