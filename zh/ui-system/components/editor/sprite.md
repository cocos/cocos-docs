...
图像的组件接口请参考 [Sprite API](__APIDOC__/zh/#/docs/3.5/zh/ui/Class/Sprite)。

关于使用可以参考范例 **Sprite**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/01.sprite) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/01.sprite)）。
