...
EditBox 的脚本接口请参考 [EditBox API](__APIDOC__/zh/#/docs/3.5/zh/ui/Class/EditBox)。

关于使用可以参考范例 **EditBox**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/12.editbox) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/12.editbox)）。
