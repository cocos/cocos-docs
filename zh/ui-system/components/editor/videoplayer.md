...
VideoPlayer 的脚本接口请参考 [VideoPlayer API](__APIDOC__/zh/#/docs/3.5/zh/component-video/Class/VideoPlayer)。
...
| Video Player Event   | 视频播放回调函数，该回调函数会在特定情况被触发，比如播放中，暂时，停止和完成播放。详情见下方的 **VideoPlayer 事件** 章节或者 [VideoPlayerEvent API](__APIDOC__/zh/#/docs/3.5/zh/component-video/Class/VideoPlayer?id=videoplayerevent)。|
...
详情可参考 API 文档 [Component.EventHandler](__APIDOC__/zh/#/docs/3.5/zh/event/Class/EventHandler)
...
详情可参考 [VideoPlayer 事件](__APIDOC__/zh/#/docs/3.5/zh/component-video/Class/VideoPlayer?id=videoplayerevent)。
...
关于完整的 VideoPlayer 的事件列表，可以参考 [VideoPlayer API](__APIDOC__/zh/#/docs/3.5/zh/component-video/Class/VideoPlayer)。
