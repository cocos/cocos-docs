...
VideoPlayer 的脚本接口请参考 [VideoPlayer API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/component-video/Class/VideoPlayer)。
...
| Video Player Event   | 视频播放回调函数，该回调函数会在特定情况被触发，比如播放中，暂时，停止和完成播放。详情见下方的 **VideoPlayer 事件** 章节或者 [VideoPlayerEvent API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/component-video/Class/VideoPlayer?id=videoplayerevent)。|
...
详情可参考 API 文档 [Component.EventHandler](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/event/Class/EventHandler)
...
详情可参考 [VideoPlayer 事件](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/component-video/Class/VideoPlayer?id=videoplayerevent)。

使用方式可参考范例 **VideoPlayer**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/21.video-player) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/21.video-player)）。
...
关于完整的 VideoPlayer 的事件列表，可以参考 [VideoPlayer API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/component-video/Class/VideoPlayer)。
...
详情可参考范例 **VideoPlayer**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/21.video-player) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/21.video-player)）。
