...
详情可参考 [WebView 事件](../../../api/zh/classes/webview.webview-1.html#webviewevents) 或者参考引擎自带的 test-cases-3d 测试例中的 [22.webview](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/ui/22.webview)。
