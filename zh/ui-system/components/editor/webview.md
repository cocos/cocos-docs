...
WebView 的脚本接口请参考 [WebView API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/component-web-view/Class/WebView)。
...
详情可参考 API 文档 [Component.EventHandler 类型](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/event/Class/EventHandler)
...
详情可参考 API [WebView 事件](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/component-web-view/Class/WebView?id=webviewevents)。

使用方式可参考范例 **Webview**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/22.webview) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/22.webview)）。
