...
WebView 的脚本接口请参考 [WebView API](__APIDOC__/zh/#/docs/3.4/zh/component-web-view/Class/WebView)。
...
详情可参考 API 文档 [Component.EventHandler 类型](__APIDOC__/zh/#/docs/3.4/zh/event/Class/EventHandler)
...
详情可参考 API [WebView 事件](__APIDOC__/zh/#/docs/3.4/zh/component-web-view/Class/WebView?id=webviewevents)。
