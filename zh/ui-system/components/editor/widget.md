...
对齐挂件的脚本接口请参考 [Widget API](__APIDOC__/zh/#/docs/3.5/zh/ui/Class/Widget)。

关于使用可以参考范例 **Widget**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/04.widget) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/04.widget)）。
