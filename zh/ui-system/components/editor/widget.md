...
关于使用可以参考范例 **Widget**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/04.widget) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.0/assets/cases/ui/04.widget)）。
