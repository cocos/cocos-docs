...
遮罩的组件接口请参考 [UIStaticBatch API](__APIDOC__/zh/#/docs/3.5/zh/ui/Class/UIStaticBatch)。

关于使用可以参考范例 **UIStaticBatch**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/19.static-ui) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/19.static-ui)）。
