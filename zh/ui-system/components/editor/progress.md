...
进度条的脚本接口请参考 [ProgressBar API](__APIDOC__/zh/#/docs/3.5/zh/ui/Class/ProgressBar)。

关于使用可以参考范例 **Progress**（[GitHub](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/11.progress) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/11.progress)）。
