...
滚动视图的脚本接口请参考 [ScrollView API](../../../api/zh/classes/ui.scrollview.html)。
...
关于完整的 ScrollView 的事件列表，可以参考 ScrollView 的 API 文档 [ScrollView API](../../../api/zh/classes/ui.scrollview.html)。
