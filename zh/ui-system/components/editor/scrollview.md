...
滚动视图的脚本接口请参考 [ScrollView API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/ui/Class/ScrollView)。
...
关于完整的 ScrollView 的事件列表，可以参考 ScrollView 的 API 文档 [ScrollView API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/ui/Class/ScrollView)。
