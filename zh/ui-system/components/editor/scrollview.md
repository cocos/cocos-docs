...
滚动视图的脚本接口请参考 [ScrollView API](__APIDOC__/zh/#/docs/3.4/zh/ui/Class/ScrollView)。

关于使用可以参考范例 **ScrollView**（[GitHub](https://github.com/cocos/cocos-test-projects/tree/v3.4/assets/cases/ui/06.scrollview) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/06.scrollview)）。
...
关于完整的 ScrollView 的事件列表，可以参考 ScrollView 的 API 文档 [ScrollView API](__APIDOC__/zh/#/docs/3.4/zh/ui/Class/ScrollView)。
