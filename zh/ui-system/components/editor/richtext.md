...
关于使用可以参考范例 **RichText**（[GitHub](https://github.com/cocos/cocos-test-projects/tree/v3.3/assets/cases/ui/07.richtext) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.3/assets/cases/ui/07.richtext)）。
