...
部分小游戏平台支持子包功能用来对资源和脚本进行划分，Creator 也将子包功能整合到 Asset Bundle 的工作流中，你可以在 Asset Bundle 的压缩类型选项中将压缩类型设置为 **小游戏子包**，则 Asset Bundle 将被构建到小游戏子包中。详细内容请参考 [Asset Bundle](../asset-manager/bundle.md#压缩类型)

如果发布平台支持子包功能，比如在微信小游戏的构建中，子包的配置也会按照规则自动生成到微信小游戏发布包目录下的 **game.json** 配置文件中。
