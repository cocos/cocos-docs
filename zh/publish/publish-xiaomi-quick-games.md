...
- **应用包名**
  ...
  **注意**：从平台版本号 **1062** 开始，小米快游戏需要使用正式申请的应用包名，否则在调试时会出现“数据加载异常，请点击重试”的报错。应用包名申请可参考 [文档](https://www.quickapp.cn/quickGameDocCenter/post/115)。
...
分包或者主包的包体大小限制，具体可参考 [小米快游戏分包规则](https://dev.mi.com/console/doc/detail?pId=2067)。

## 相关参考链接

- [小米快游戏开发者接入指南](https://dev.mi.com/console/doc/detail?pId=1779)
- [小米快游戏分包规则](https://dev.mi.com/console/doc/detail?pId=2067)
