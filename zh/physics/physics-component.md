...
盒碰撞器组件接口请参考 [BoxCollider API](https://docs.cocos.com/creator/api/zh/classes/physics.boxcollider.html)。
...
球碰撞器组件接口请参考 [SphereCollider API](https://docs.cocos.com/creator/api/zh/classes/physics.spherecollider.html)。
...
圆柱碰撞器组件接口请参考 [CylinderCollider API](https://docs.cocos.com/creator/api/zh/classes/physics.cylindercollider.html)。
...
胶囊碰撞器组件接口请参考 [CapsuleCollider API](https://docs.cocos.com/creator/api/zh/classes/physics.capsulecollider.html)。
...
圆锥碰撞器组件接口请参考 [ConeCollider API](https://docs.cocos.com/creator/api/zh/classes/physics.conecollider.html)。
...
平面碰撞器组件接口请参考 [PlaneCollider API](https://docs.cocos.com/creator/api/zh/classes/physics.planecollider.html)。
...
网格碰撞器组件接口请参考 [MeshCollider API](https://docs.cocos.com/creator/api/zh/classes/physics.meshcollider.html)。
...
单纯形碰撞器组件接口请参考 [SimplexCollider API](https://docs.cocos.com/creator/api/zh/classes/physics.simplexcollider.html)。
...
刚体组件接口请参考 [RigidBody API](https://docs.cocos.com/creator/api/zh/classes/physics.rigidbody.html)。
...
恒力组件接口请参考 [ConstantForce API](https://docs.cocos.com/creator/api/zh/classes/physics.constantforce.html)。
