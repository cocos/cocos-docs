...
圆柱碰撞器组件接口请参考 [CylinderCollider API](https://docs.cocos.com/creator3d/api/zh/classes/physics.cylindercollider.html)。
...
胶囊碰撞器组件接口请参考 [CapsuleCollider API](https://docs.cocos.com/creator3d/api/zh/classes/physics.capsulecollider.html)。
