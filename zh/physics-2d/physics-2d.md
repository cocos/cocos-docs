...
Cocos Creator 3.0 支持内置的轻量 Builtin 物理系统和强大的 Box2D 物理系统。对于物理计算较为简单的情况，我们推荐使用 Builtin 物理模块，Builtin 物理系统只提供了碰撞检测的功能，这样可以避免加载运行时开销。而对于功能比较复杂的需求，则需要提供了更完善的交互接口和刚体、关节等已经预设好的组件的Box2D 物理系统。
