...
以下示例可以在 [GitHub](https://github.com/cocos/cocos-test-projects/tree/v3.7/preview-template) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.7/preview-template) 查找到。
