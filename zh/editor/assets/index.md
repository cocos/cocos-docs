...
- 面板和节点都有右击菜单事件，是重要的操作功能，右击菜单中的灰色选项则为不可用菜单。
...
选中需要重命名的资源，然后点击右键，选择 **重命名** 即可修改节点名称，或者也可以直接使用快捷键 **Enter** 或者 **F2**。点击面板其他地方或者按快捷键 **Esc** 便可以取消此次重命名。
