...
当我们在 Creator 外进行资源操作，回到 Creator 的时候。Creator 会进行一个资源的检查。当文件数量过多，或者硬盘随机读写速度偏低的时候，就会造成资源系统响应延迟。例如点击资源，inspector 延迟一会儿才显示。

这时候我们可以关闭 Creator 的自动刷新功能，但关闭该功能后，当我们确实进行了资源操作的时候，需要点击 assets 面板上的刷新按钮主动刷新。

所以如果没有遇到资源系统响应问题，不建议关闭这个选项。
