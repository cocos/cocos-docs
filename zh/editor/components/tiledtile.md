...
相关 TiledTile 脚本接口请参考 [TiledTile API](__APIDOC__/zh/#/docs/3.5/zh/tiledmap/Class/TiledTile)
...
Layer 脚本接口相关请参考 [TiledLayer API](__APIDOC__/zh/#/docs/3.5/zh/tiledmap/Class/TiledLayer)
