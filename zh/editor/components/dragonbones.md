...
- ArmatureDisplay 组件的使用方法可参考 **DragonBones**（[GitHub](https://github.com/cocos/cocos-test-projects/tree/v3.5/assets/cases/dragonbones) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/dragonbones)）范例。
...
6. 保存场景后，点击编辑器上方的预览按钮，然后点击 **Left**/**Right** 按钮即可看到机器人左/右手的武器已经被替换。
    ...
    详情可参考官方范例 **ReplaceSlotDisplay**（[GitHub](https://github.com/cocos/cocos-test-projects/tree/v3.5/assets/cases/dragonbones) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/dragonbones)）。
