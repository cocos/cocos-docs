...
- Spine Skeleton 组件的使用方法可参考 [Spine 范例](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/spine)。
...
4. 点击编辑器上方的预览按钮，即可看到 Spine 动画顶点抖动的效果。详情可参考 [SpineMesh](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/spine) 官方范例。
...
5. 保存场景，点击编辑器上方的预览按钮，也可以看到星星挂在龙的尾巴上，并随着龙的尾巴一起晃动。具体可参考官方 [SpineAttach](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/spine) 范例。
...
6. 点击编辑器上方的预览按钮，即可看到效果。具体可参考 [SpineCollider](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/spine) 范例。
