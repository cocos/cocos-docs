...
第一行的语言为 **本地开发语言**，记录当前开发过程中所使用的本地语言，通常可以选择为开发者熟悉的语言。在该语言下，**操作** 栏中会出现 **补全** 功能，用于记录 Label 组件的原文，需搭配 [L10nLabel](l10n-label.md) 使用，在有键无值的情况下使用；或匹配非文本资源的多语言。详情请参考下文 **补全** 部分。
...
详细的导入示例请参考 [示例](example-excel.md)
