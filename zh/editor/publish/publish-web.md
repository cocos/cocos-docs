...
| Polyfills | 构建支持一些脚本新特性的 polyfills，在打包脚本时会做对应处理，目前包括 **anyncFunctions** 和 **coreJs** 两种，开发者可以根据实际需求选择需要的 polyfills。 | `polyfills` |
...
移动设备上测试的浏览器包括：Safari、Chrome、QQ 浏览器、UC 浏览器和微信内置 WebView。
