...
- 回调参数
    ...
    - [EventMouse](__APIDOC__/zh/#/docs/3.5/zh/cocos-input-types-event/Class/EventMouse) 或 [EventTouch](__APIDOC__/zh/#/docs/3.5/zh/cocos-input-types-event/Class/EventTouch)
...
- 回调参数
    ...
    - [EventKeyboard](__APIDOC__/zh/#/docs/3.5/zh/event/Class/EventKeyboard)
...
- 回调参数
    ...
    - [EventAcceleration](__APIDOC__/zh/#/docs/3.5/zh/cocos-input-types-event/Class/EventAcceleration)
