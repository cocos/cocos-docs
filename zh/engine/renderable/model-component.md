...
网格渲染器组件相关接口请参考 [MeshRenderer API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/3d/Class/MeshRenderer)。

蒙皮网格渲染器组件相关接口请参考 [SkinnedMeshRenderer API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/3d/Class/SkinnedMeshRenderer)
