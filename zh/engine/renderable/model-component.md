...
普通模型的组件接口请参考 [MeshRenderer API](../../../api/zh/classes/model.meshrenderer.html)。

蒙皮模型的组件接口请参考 [SkinnedMeshRenderer API](../../../api/zh/classes/model.skinnedmeshrenderer.html)
