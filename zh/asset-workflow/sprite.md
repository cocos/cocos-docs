...
**// 结果颜色 = 源颜色值 * 源alpha值 + 目标颜色值 * (1 - 源 alpha 值)**
...
假设有两个相邻顶点的像素颜色，一个是顶点颜色为透明度 100% 的红色（255，0，0，1），另一个是顶点颜色为透明度 10% 的绿色（0，255，0，0.1），那么当图像缩放时这两个顶点之间的颜色就是对它们进行线性插值的结果。如果是 Non-Premultiply Alpha ，那么结果为：
