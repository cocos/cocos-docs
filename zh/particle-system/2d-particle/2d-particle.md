...
ParticleSystem2D 的脚本接口请参考 [ParticleSystem API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/particle2d/Class/ParticleSystem2D)。
...
| PositionType         | 粒子位置类型，包括 **FREE**、**RELATIVE**、**GROUPED** 三种。详情可参考 [PositionType API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/particle2d/Class/ParticleSystem2D?id=positiontype-1)
| EmitterMode          | 发射器类型，包括 **GRAVITY**、**RADIUS** 两种。详情可参考 [EmitterMode API](https://docs.cocos.com/creator/3.4/api/zh/#/docs/3.4/zh/particle2d/Class/ParticleSystem2D?id=emittermode)
