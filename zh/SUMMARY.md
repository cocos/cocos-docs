...
- [扩展系统](editor/extension/readme.md)
    - [制作第一个插件](editor/extension/first-plugin.md)
    - [扩展结构](editor/extension/first.md)
        - [扩展已有功能](editor/extension/contributions.md)
            ...
            - [扩展资源管理器面板](editor/extension/contributions-assets.md)
        ...
        - [扩展面板](editor/extension/first-panel.md)
            - [面板结构](editor/extension/panel.md)
            - [与面板通信](editor/extension/to-panel-messages.md)
            - [面板数据存储](editor/extension/panel-messages.md)
