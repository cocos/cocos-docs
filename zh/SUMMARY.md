...
- [一键接入第三方服务](cocos-service/index.md)
    ...
    - [服务列表](cocos-service/service-index.md)
        ...
        - [性能管理（AppGallery Connect）](cocos-service/agc-apm.md)
        - [认证服务（AppGallery Connect）](cocos-service/agc-auth.md)
        - [崩溃服务（AppGallery Connect）](cocos-service/agc-crash.md)
        - [远程配置服务（AppGallery Connect）](cocos-service/agc-remote.md)
