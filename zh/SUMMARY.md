...
- [扩展编辑器](editor/extension/readme.md)
    ...
    - [扩展面板](editor/extension/panel/index.md)
        - [编写面板](editor/extension/panel/boot.md)
        - [面板与插件的通信](editor/extension/panel/messages.md)
        - [与面板的通信](editor/extension/panel/to-panel-messages.md)
    - [扩展已有功能](editor/extension/contributions/index.md)
        - [扩展消息通信](editor/extension/contributions/messages/index.md)
        - [扩展快捷键](editor/extension/contributions/shortcuts/index.md)
        ...
        - [扩展偏好设置](editor/extension/contributions/preferences/index.md)
        - [扩展项目设置](editor/extension/contributions/project/index.md)
    ...
    - [基础功能](editor/extension/basic/index.md)
        ...
        - [多语言系统](editor/extension/basic/i18n.md)
        - [配置系统](editor/extension/basic/profile.md)
        - [UI 组件](editor/extension/basic/ui.md)
