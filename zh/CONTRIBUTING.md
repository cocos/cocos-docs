...
### 面板名称或其他重要界面元素，用加粗显示，并且相邻的正文之间需要加空格
...
### 编辑器文档中，属性名按照属性检查器里显示的格式书写，并且和相邻的正文之间加 backtick 和空格
...
### 脚本文档中，属性和方法名按照 API 里显示的格式书写，并且和相邻的正文之间加 backtick 和空格
...
> eg：[Mask API]\(../../../api/zh/classes/Mask.html)。跨文档的文件名后缀要使用 **.html**
