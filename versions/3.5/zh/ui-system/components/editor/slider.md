...
关于使用可以参考范例 **Slider**（[GitHub](https://github.com/cocos/cocos-test-projects/tree/v3.5/assets/cases/ui/10.slider) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/10.slider)）。
