...
To use graphics, please refer to the [graphics API](%__APIDOC__%/en/class/GraphicsComponent) documentation and the [graphics](https://github.com/cocos/cocos-test-projects/tree/v3.8/assets/cases/ui/14.graphics) scene of the test-cases-3d project.
