...
For related TiledTile script interface, please refer to the [TiledTile API](__APIDOC__/en/#/docs/3.4/en/tiledmap/Class/TiledTile).
...
For the Layer script interface, please refer to the [TiledLayer API](__APIDOC__/en/#/docs/3.4/en/tiledmap/Class/TiledLayer).
