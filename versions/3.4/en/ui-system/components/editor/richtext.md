...
To use `RichText`, please refer to the [RichText API](%__APIDOC__%/en/#/docs/3.4/en/ui/Class/RichText) documentation and the [RichText](https://github.com/cocos/cocos-test-projects/tree/v3.4/assets/cases/ui/07.richtext) scene of the test-cases-3d project.
