...
2. **BATCHER2D_MEM_INCREMENT** is measured in **kilobytes**. Users can follow the instructions below to calculate the corresponding capacity for vertex numbers:
    ...
    Vertices in Cocos Creator are formatted as [vfmtPosUvColor](https://github.com/cocos/cocos4/blob/v4.0.0/cocos/2d/renderer/vertex-format.ts#L43), its definitions as follows:
