...
> 2. Joint components are required with [rigid body](./physics-2d-rigid-body.md) and [collider](./physics-2d-collider.md) to work correctly. As shown in the following figure.
>
