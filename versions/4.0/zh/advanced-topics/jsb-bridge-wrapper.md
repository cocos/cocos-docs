...
- 在 Objective-C 端，可查看 [JsbBridgeWrapper.h](https://github.com/cocos/cocos4/blob/v4.0.0/native/cocos/platform/apple/JsbBridgeWrapper.h) ：
...
- 安卓可查看 [JsbBridgeWrapper.java](https://github.com/cocos/cocos4/blob/v4.0.0/native/cocos/platform/android/java/src/com/cocos/lib/JsbBridgeWrapper.java)：
...
- Huawei HarmonyOS 也可以通过 [JsbBridgeWrapper.java](https://github.com/cocos/cocos4/blob/v4.0.0/native/cocos/platform/ohos/libcocos/src/main/java/com/cocos/lib/JsbBridgeWrapper.java) 查看其实现方式。
