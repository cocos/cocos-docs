...
| 商城 | 点击该项即可进入 Cocos Creator 内置的 [扩展商城](https://store.cocos.com/app/)，可供用户浏览、下载和自动安装官方或者第三方扩展和资源。同时用户也可以将自己开发的扩展、美术素材、音乐音效等资源提交到扩展商店以便分享或者售卖。详情请参考 [提交资源到商店](../extension/store/upload-store.md) |
...
| 消息列表 |  打开 [消息列表](../messages.md#查看消息列表) 面板，用于显示编辑器每个功能定义的公开消息及其说明|
...
| 引擎仓库 |  在默认浏览器打开 [TypeScript 引擎仓库](https://github.com/cocos/cocos4/) |
