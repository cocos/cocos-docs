...
- **As of v2.4.15**，Cocos Creator supports publishing to [Honor Mini Games](publish/publish-honor-mini-game.md)。
- **As of v2.4.14**，Cocos Creator supports publishing to [Migu Mini Games](publish/publish-migu-mini-game.md)。
