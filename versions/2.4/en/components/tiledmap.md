...
API reference: [TiledMap API](%__APIDOC__%/en/classes/TiledMap.html).
...
5. Click the preview button at the top of the editor, we can see the effect that the nodes and the map layer mutual overlap. About the code, please refer to [ShieldNode](https://github.com/cocos/example-projects/tree/v2.4.3/assets/cases/tiledmap) for details.
