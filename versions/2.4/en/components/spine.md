...
4. You can see the vertex jitter effect of the Spine animation by clicking the preview button above the editor. For the code, please refer to [SpineMesh](https://github.com/cocos/example-projects/tree/v2.4.3/assets/cases/spine) for details.
...
7. You can see the effect by clicking the preview button above the editor. For details, please refer to the [SpineCollider](https://github.com/cocos/example-projects/tree/v2.4.3/assets/cases/spine) in example-case.
