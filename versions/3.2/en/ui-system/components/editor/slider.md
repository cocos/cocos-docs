...
To use `Slider`, please refer to the [Slider API](%__APIDOC__%/en/classes/ui.slider.html) documentation and the [Slider](https://github.com/cocos/cocos-test-projects/tree/v3.0/assets/cases/ui/10.slider) scene of the test-cases-3d project.
