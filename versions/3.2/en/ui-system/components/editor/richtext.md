...
To use `RichText`, please refer to the [RichText API](%__APIDOC__%/en/classes/ui.richtext.html) documentation and the [RichText](https://github.com/cocos/cocos-test-projects/tree/v3.0/assets/cases/ui/07.richtext) scene of the test-cases-3d project.
