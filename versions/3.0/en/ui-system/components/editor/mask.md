...
To use `Mask`, please refer to the [Mask API](__APIDOC__/en/classes/ui.mask-1.html) documentation and the [Mask](https://github.com/cocos/cocos-test-projects/tree/v3.0/assets/cases/ui/08.mask) scene of the test-cases-3d project.
