...
To use `Widget`, please refer to the [Widget API](%__APIDOC__%/en/classes/ui.widget.html) documentation and the [Widget](https://github.com/cocos/cocos-test-projects/tree/v3.0/assets/cases/ui/04.widget) scene of the test-cases-3d project.
