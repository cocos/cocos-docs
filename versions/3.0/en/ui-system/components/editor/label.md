...
To use `Label`, please refer to the [Label API](__APIDOC__/en/classes/ui.label.html) documentation and the [label](https://github.com/cocos/cocos-test-projects/tree/v3.0/assets/cases/ui/02.label) scene of the test-cases-3d project.
