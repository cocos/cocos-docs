...
- **downloader，loader，md5Pipe，subPackPipe**
  ...
  `loader.downloader` 可由 `assetManager.downloader` 代替，`loader.loader` 可由 `assetManager.parser` 代替。但其中的接口没有完全继承，具体内容请参考文档 [下载与解析](downloader-parser.md) 或者 API 文档 [assetManager.downloader](%__APIDOC__%/zh/#/docs/3.3/zh/asset-manager/Class/AssetManager?id=downloader) 和 [assetManager.parser](__APIDOC__/zh/#/docs/3.3/zh/asset-manager/Class/AssetManager?id=parser)。
