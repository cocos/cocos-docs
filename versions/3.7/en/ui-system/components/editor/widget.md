...
To use `Widget`, please refer to the [Widget API](__APIDOC__/en/class/Widget) documentation and the [Widget](https://github.com/cocos/cocos-test-projects/tree/v3.7/assets/cases/ui/04.widget) scene of the test-cases-3d project.
