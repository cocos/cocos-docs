...
To use graphics, please refer to the [graphics API](__APIDOC__/en/class/Graphics) documentation and the [graphics](https://github.com/cocos/cocos-test-projects/tree/v3.6/assets/cases/ui/14.graphics) scene of the test-cases-3d project.
