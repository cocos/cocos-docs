...
For details on how to use it, please refer to the [MotionStreak](https://github.com/cocos/cocos-test-projects/tree/v3.6/assets/cases/ui/24.motion-streak) example.
