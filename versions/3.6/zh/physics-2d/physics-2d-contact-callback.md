...
> **注意**：
> 1. Box2D 物理模块需要先在 [Rigidbody](physics-2d-rigid-body.md) 中 **开启碰撞监听**，才会有相应的回调产生。Builtin 物理模块只需要有碰撞体组件就可以产生碰撞回调。开启方法为，在 **Rigidbody2D** 的 **属性检查器** 勾选 **EnabledContactListener** 属性，如下图所示：
