...
关于使用可以参考范例 **UIStaticBatch**（[GitHub](https://github.com/cocos/cocos-test-projects/tree/v3.6/assets/cases/ui/19.static-ui) | [Gitee](https://gitee.com/mirrors_cocos-creator/test-cases-3d/tree/v3.6/assets/cases/ui/19.static-ui)）。
