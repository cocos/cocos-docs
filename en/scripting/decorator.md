...
For convenience, several additional decorators are provided to quickly declare cc types. For properties where only type is defined use:
...
For more on parameters, see [Attributes](./reference/attributes.md).
