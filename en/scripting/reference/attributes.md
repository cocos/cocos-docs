...
| :--- | :--- | :--- | :--- | :--- |
| type | Restrict the data type of the property | (Any) | undefined | See [type attribute](../ccclass.md#type-attribute) |
| visible | Show or hide in the **Inspector** panel | boolean | (Note 1) | See [visible attribute](./ccclass.md#visible-attribute) |
...
| Attribute Name | Description | Type | Default | Remarks |
| :--- | :--- | :--- | :--- | :--- |
| default | Define the default value of an attribute | (Any) | undefined | See [default attribute](.../ccclass.md#default-attribute) |
