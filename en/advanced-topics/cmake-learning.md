...
Let's take Android platform as an example and see how to configure `CMakeLists.txt` in the project directory `native/engine/android`.
...
For more, see the official CMake documentation [target_include_directories](https://cmake.org/cmake/help/latest/command/target_include_directories.html).
...
- The `add_library` directive generates
   ...
   The `add_library` directive generates a link file from the specified source file and then adds it to the project.
    ...
    For more details, please refer to the official CMake documentation [add_library](https://cmake.org/cmake/help/v3.16/command/add_library.html).
...
For more, see the official CMake documentation [target_link_libraries](https://cmake.org/cmake/help/latest/command/target_link_libraries.html).
...
There are many more commands and usages of CMake, welcome to explore and learn them. This document is just a simple example, developers can customize their own workflow for their actual situation. In the future, Cocos Creator will also integrate more CMake features into the editor's **Build** panel for easy use.

For more details about CMake syntax and interface, please refer to [CMake official documentation](https://cmake.org/cmake/help/v3.16/guide/tutorial/index.html).
