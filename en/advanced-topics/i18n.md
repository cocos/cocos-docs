...
> i18n multi-language support this part of the content is currently not manpowered and has not been updated for a long time, may not work properly. It is recommended to use dynamic loading and other ways to handle multi-language related logic.
