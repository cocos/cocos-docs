...
In the example project, we provided a [version_generator.js](https://github.com/cocos-creator/tutorial-hot-update/tree/%3C%3Dv2.0.6/version_generator.js) script file, which is a Nodejs script for generating manifest file. Use as follows:
