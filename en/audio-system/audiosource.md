...
For more audio-related scripting interfaces, please refer to [AudioSource API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/component-audio/Class/AudioSource).
