...
The specific usage can be found in the example [event](https://github.com/cocos/cocos-test-projects/tree/v3.5/assets/cases/event), which contains the implementation of keyboard, accelerometer, single-touch, multi-touch and other functions.
