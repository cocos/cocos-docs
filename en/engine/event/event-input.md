...
- Callback parameter
    ...
    - [EventMouse](__APIDOC__/en/#/docs/3.5/en/cocos-input-types-event/Class/EventMouse) or [EventTouch](__APIDOC__/en/#/docs/3.5/en/cocos-input-types-event/Class/EventTouch)
...
- Callback parameter
    ...
    - [EventKeyboard](__APIDOC__/en/#/docs/3.5/en/event/Class/EventKeyboard)
...
- Callback parameter
    ...
    - [EventAcceleration](__APIDOC__/en/#/docs/3.5/en/cocos-input-types-event/Class/EventAcceleration)
...
The specific usage can be found in the example [event](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/event), which contains the implementation of keyboard, accelerometer, single-touch, multi-touch and other functions.
