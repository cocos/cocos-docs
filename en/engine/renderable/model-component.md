...
The component interfaces for the common model are described in [MeshRenderer API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/3d/Class/MeshRenderer).

The component interfaces for the skinning model are described in [SkinnedMeshRenderer API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/3d/Class/SkinnedMeshRenderer).
