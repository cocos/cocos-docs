...
- If the curve value is [interpolable](__APIDOC__/en/interfaces/animation.ilerpable.html), the curve value's `lerp` function will be called to complete the **interpolation** <sup id="a2">[2](#f2)</sup>.
...
For more **looping** modes, see [WrapMode](__APIDOC__/en/enums/animation.wrapmode.html).
