...
To use __BoxCollider__, please refer to the [BoxCollider API](__APIDOC__/en/class/physics.BoxCollider).
...
To use __SphereCollider__, please refer to the [SphereCollider API](__APIDOC__/en/class/physics.SphereCollider).
...
To use __CylinderCollider__, please refer to the [CylinderCollider API](__APIDOC__/en/class/physics.CylinderCollider).
...
To use __CapsuleCollider__, please refer to the [CapsuleCollider API](__APIDOC__/en/class/physics.CapsuleCollider).
...
To use __ConeCollider__, please refer to the [ConeCollider API](__APIDOC__/en/class/physics.ConeCollider).
...
To use __PlaneCollider__, please refer to the [PlaneCollider API](__APIDOC__/en/class/physics.PlaneCollider).
...
To use __MeshCollider__, please refer to the [MeshCollider API](__APIDOC__/en/class/physics.MeshCollider).
...
To use __SimplexCollider__, please refer to the [SimplexCollider API](__APIDOC__/en/class/physics.SimplexCollider).
...
To use __RigidBody__, please refer to the [RigidBody API](__APIDOC__/en/class/physics.RigidBody).
...
To use __ConstantForce__, please refer to the [ConstantForce API](__APIDOC__/en/class/physics.ConstantForce).
