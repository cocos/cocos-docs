...
To use __BoxCollider__, please refer to the [BoxCollider API](../../../api/en/classes/physics.boxcollider.html).
...
To use __SphereCollider__, please refer to the [SphereCollider API](../../../api/en/classes/physics.spherecollider.html).
...
To use __CylinderCollider__, please refer to the [CylinderCollider API](../../../api/en/classes/physics.cylindercollider.html).
...
To use __CapsuleCollider__, please refer to the [CapsuleCollider API](../../../api/en/classes/physics.capsulecollider.html).
...
To use __ConeCollider__, please refer to the [ConeCollider API](../../../api/en/classes/physics.conecollider.html).
...
To use __PlaneCollider__, please refer to the [PlaneCollider API](../../../api/en/classes/physics.planecollider.html).
...
To use __MeshCollider__, please refer to the [MeshCollider API](../../../api/en/classes/physics.meshcollider.html).
...
To use __RigidBody__, please refer to the [RigidBody API](../../../api/en/classes/physics.rigidbody.html).
...
To use __ConstantForce__, please refer to the [ConstantForce API](../../../api/en/classes/physics.constantforce.html).
