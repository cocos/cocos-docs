...
Set whether to use high resolution through `view.enableRetina(true)` in the script. Retina display will be turned on by default when it is built on the Web platform. For details, please refer to the [enableRetina](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/core/Class/View?id=enableretina) API.
