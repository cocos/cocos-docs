...
If set, the start scene and its related dependent resources are built into the built-in Asset Bundle ¡ª [start-scene](../../asset/bundle.md#the-built-in-asset-bundle) to speed up the resource loading of the start scene. Please refer to the [Start Scene Loading](#speed-up-the-loading-of-the-start-scene) for details.
