...
1. Use **Cocos Creator 3.0** to open the project that needs to be released. Select **Huawei Quick Game** in the **Platform** dropdown of the **Build** panel.
    ...
    ![huawei options](./huawei-mini-game/huawei_options.jpg)
...
To use this function, you need to set the [Bundle Configuration](subpackage.md) in **Cocos Creator**, and the package will be automatically subpackaged when the setting is completed.
