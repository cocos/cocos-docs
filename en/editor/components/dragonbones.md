...
- For information on using the ArmatureDisplay component, please refer to the [DragonBones example case](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/dragonbones) for details.
- For DragonBones ArmatureDisplay related scripting interfaces, please refer to the [ArmatureDisplay API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/dragonBones/Class/ArmatureDisplay) for details.
