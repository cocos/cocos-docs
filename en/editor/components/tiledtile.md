...
For related TiledTile script interface, please refer to the [TiledTile API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/tiledmap/Class/TiledTile).
...
For the Layer script interface, please refer to the [TiledLayer API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/tiledmap/Class/TiledLayer).
