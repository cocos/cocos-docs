...
- For Spine Skeleton component related scripting interfaces, please refer to the [Spine Skeleton API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/spine/Class/Skeleton) for details.
