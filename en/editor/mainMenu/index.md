...
| Light | Create Creator preset nodes in the scene containing base light components, currently including **Parallel Light**, **Spherical Light** and **Spot Light**, please refer to the [Light](../../concepts/scene/light.md) documentation. |
...
| Camera | Creates a node in the scene with the Camera component pre-defined by the Creator. For details on how to use it, please refer to the [Camera Components](../components/camera-component.md) documentation. |
