...
The [Open Data Context Sample Project](https://github.com/cocos-creator/demo-wechat-subdomain/archive/master.zip) provided by __Cocos Creator__ contains examples of the use of WeChat open data contexts.
