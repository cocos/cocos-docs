...
- Fill in the applied **appid** and **game 版本号**
  ...
  **game 版本号** is the version characteristic value of the game package, normally generated by the platform. Here used for debugging purposes, and it is generally a random string of letters and numbers.

  > **Note**: a new value is re-entered for each replacement package.

- After setting, click the **打开游戏** button below to open the game.

  > **Note**: if you want to open the game again, you need to re-place the cpk package in the file path described above.
