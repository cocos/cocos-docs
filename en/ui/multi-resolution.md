...
If there are no strict requirements for the content that might be cut down on the four sides of the screen, you can not check the **Fit Height** and **Fit Width** mode of the Canvas component at the same time, this is equivalent to turning on the **No_Border** mode. In this case, the height and width are automatically adapted according to the ratio of width to height of the screen to avoid black borders. At this point, no black border is generated regardless of the ratio of width to height of the screen. In other words, when the ratio of width to height of the design resolution is larger than that of the screen resolution, **Fit Height** will be automatically opened (as in the first picture above); when the ratio of width to height of the design resolution is smaller than that of the screen resolution, **Fit Width** will be automatically opened(as in the second picture above).
