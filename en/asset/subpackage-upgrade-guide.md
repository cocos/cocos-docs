...
For APIs related to the **Asset Bundle**, please refer to the [Asset Bundle API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/asset-manager/Class/Bundle) documentation.
