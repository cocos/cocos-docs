...
When needing to switch **Scenes** in the game, use the [director.loadScene()](__APIDOC__/en/#/docs/3.5/en/core/Class/Director?id=loadscene) API to implement dynamic scene loading and switching in the game.
