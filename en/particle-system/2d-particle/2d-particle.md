...
For the script interface of ParticleSystem2D, please refer to [ParticleSystem API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/particle2d/Class/ParticleSystem2D).
...
| PositionType       | The type of particle position, including **FREE**, **RELATIVE**, **GROUPED**. For details, please refer to [PositionType API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/particle2d/Class/ParticleSystem2D?id=positiontype).
| EmitterMode        | The type of the emitter, including **GRAVITY**, **RADIUS**. For details, please refer to [EmitterMode API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/particle2d/Class/ParticleSystem2D?id=emittermode).
...
For more specific usage, please refer to the official [ui/25.particle](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/25.particle) example.
