...
For the Spotlight component interface, please refer to [SpotLight API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/component-light/Class/SpotLight).
