...
| **AutoAdapt**       | Check this option to enable the following properties for setting the range of shadow generation. Please refer to the section **AutoAdapt Adaptive Shadow Calculation** below for details.    |
