...
- [Build and Publish](editor/publish/index.md)
  ...
  - [Publishing to Native](editor/publish/native-options.md)
    - [Setup Native Development](editor/publish/setup-native-development.md)
      - [Native platform common options and basic directory structure](editor/publish/native-options.md)
  ...
  - [Publish to Mini Games](editor/publish/publish-alipay-mini-game.md)
