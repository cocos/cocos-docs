...
You can read the [Basic concepts chapter of the Cocos2d-x programmer guide](http://docs.cocos2d-x.org/cocos2d-x/en/basic_concepts/), it describes the node tree very well with some pictures below.
