...
For more information about **VideoPlayer**'s scripting interface, please refer to the [VideoPlayer API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/component-video/Class/VideoPlayer) documentation.
...
| **Video Player Event**   | The video player's callback, it will be triggered when certain event occurs. Please refer to the `VideoPlayer Event` section below or [VideoPlayerEvent API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/component-video/Class/VideoPlayer?id=videoplayerevent) for more details. |
...
For more information, please refer to the [Component.EventHandler Class](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/event/Class/EventHandler) documentation.
...
Please refer to the [VideoPlayer API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/component-video/Class/VideoPlayer) documentation for details on **VideoPlayer** events.
