...
To use `UIStaticBatch`, please refer to the [UIStaticBatch API](__APIDOC__/en/#/docs/3.5/en/ui/Class/UIStaticBatch) documentation and the [UIStaticBatch](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/19.static-ui) scene of the test-cases-3d project.
