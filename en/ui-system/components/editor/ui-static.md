...
To use `UIStaticBatch`, please refer to the [UIStaticBatch API](https://docs.cocos.com/creator/3.0/api/en/classes/ui.uistaticbatch.html) documentation and the [UIStaticBatch](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/19.static-ui) scene of the test-cases-3d project.
