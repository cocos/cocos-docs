...
To use `RichText`, please refer to the [RichText API](../../../api/en/classes/ui.richtext.html) documentation and the [richText](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/07.richtext) scene of the test-cases-3d project.
