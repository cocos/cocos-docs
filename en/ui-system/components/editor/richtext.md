...
To use `RichText`, please refer to the [RichText API](__APIDOC__/en/#/docs/3.3/en/ui/Class/RichText) documentation and the [RichText](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/ui/07.richtext) scene of the test-cases-3d project.
