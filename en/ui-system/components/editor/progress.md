...
To use `Progress`, please refer to the [Mask API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/ui/Class/ProgressBar) documentation and the [Progress](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/11.progress) scene of the test-cases-3d project.
