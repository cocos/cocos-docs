...
To use `Progress`, please refer to the [Mask API](__APIDOC__/en/#/docs/3.3/en/ui/Class/ProgressBar) documentation and the [Progress](https://github.com/cocos/cocos-test-projects/tree/v3.3/assets/cases/ui/11.progress) scene of the test-cases-3d project.
