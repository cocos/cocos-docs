...
To use `Progress`, please refer to the [Mask API](https://docs.cocos.com/creator/api/en/classes/ui.progressbar.html) documentation and the [progress](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/11.progress) scene of the test-cases-3d project.
