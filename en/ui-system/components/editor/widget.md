...
To use `Widget`, please refer to the [Widget API](https://docs.cocos.com/creator/api/en/classes/ui.widget.html) documentation and the [widget](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/04.widget) scene of the test-cases-3d project.
