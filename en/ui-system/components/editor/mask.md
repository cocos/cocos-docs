...
To use `Mask`, please refer to the [Mask API](__APIDOC__/en/class/Mask) documentation and the [Mask](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/08.mask) scene of the test-cases-3d project.
