...
To use `Mask`, please refer to the [Mask API](__APIDOC__/en/#/docs/3.4/en/ui/Class/Mask) documentation and the [Mask](https://github.com/cocos/cocos-test-projects/tree/v3.4/assets/cases/ui/08.mask) scene of the test-cases-3d project.
