...
To use `PageView`, please refer to the [PageView API](__APIDOC__/en/#/docs/3.5/en/ui/Class/PageView) documentation and the [PageView](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/15.pageview) scene of the test-cases-3d project.
