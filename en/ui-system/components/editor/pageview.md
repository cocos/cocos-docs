...
To use `PageView`, please refer to the [PageView API](https://docs.cocos.com/creator/3.0/api/en/classes/ui.pageview.html) documentation and the [pageView](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/15.pageview) scene of the test-cases-3d project.
