...
To use graphics, please refer to the [graphics API](__APIDOC__/en/#/docs/3.4/en/ui/Class/Graphics) documentation and the [graphics](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/14.graphics) scene of the test-cases-3d project.
