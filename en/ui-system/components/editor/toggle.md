...
To use `Toggle`, please refer to the [Toggle API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/ui/Class/Toggle) documentation and the [Toggle](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/09.toggle) scene of the test-cases-3d project.
