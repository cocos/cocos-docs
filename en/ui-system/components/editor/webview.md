...
For more information, please refer to the [WebView API](__APIDOC__/en/#/docs/3.5/en/component-web-view/Class/WebView) documentation.
...
For more information, please refer to the [WebView Events](__APIDOC__/en/#/docs/3.5/en/component-web-view/Class/WebView?id=webviewevents) documentation or [22.webview example](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/22.webview) of the `test-cases-3d` samples bundled with Creator.
