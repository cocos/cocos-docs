...
To use `Label`, please refer to the [Label API](https://docs.cocos.com/creator/api/en/classes/ui.label.html) documentation and the [label](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/02.label) scene of the test-cases-3d project.
