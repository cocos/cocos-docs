...
To use `Label`, please refer to the [Label API](__APIDOC__/en/#/docs/3.4/en/ui/Class/Label) documentation and the [label](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/02.label) scene of the test-cases-3d project.
...
| **IsBold** | If enabled, bold effect will be added to the text. (Takes effect when using __System Font__ or some __TTF Font__). Not effective when the Cache is in CHAR mode currently.|
| **IsItalic** | If enabled, italic effect will be added to the text. (Takes effect when using __System Font__ or some __TTF Font__). Not effective when the Cache is in CHAR mode currently.|
| **IsUnderline** | If enabled, underline effect will be added to the text. (Takes effect when using __System Font__ or __TTF Font__). Not effective when the Cache is in CHAR mode currently.|
