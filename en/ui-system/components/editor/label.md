...
To use `Label`, please refer to the [Label API](../../../api/en/classes/ui.label.html) documentation and the [label](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/ui/02.label) scene of the test-cases-3d project.
