...
To use `Label`, please refer to the [Label API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/ui/Class/Label) documentation and the [label](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/02.label) scene of the test-cases-3d project.
