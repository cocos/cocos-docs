...
To use `Label`, please refer to the [Label API](__APIDOC__/en/#/docs/3.3/en/ui/Class/Label) documentation and the [label](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/ui/02.label) scene of the test-cases-3d project.
