...
To use `Sprite`, please refer to the [Sprite API](__APIDOC__/en/#/docs/3.5/en/ui/Class/Sprite) documentation and the [Sprite](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/01.sprite) scene of the test-cases-3d project.
