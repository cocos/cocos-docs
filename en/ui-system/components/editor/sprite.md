...
To use `Sprite`, please refer to the [Sprite API](__APIDOC__/en/class/Sprite) documentation and the [Sprite](https://github.com/cocos/cocos-test-projects/tree/v3.5/assets/cases/ui/01.sprite) scene of the test-cases-3d project.
