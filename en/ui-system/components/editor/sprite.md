...
To use `Sprite`, please refer to the [Sprite API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/ui/Class/Sprite) documentation and the [Sprite](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/01.sprite) scene of the test-cases-3d project.
