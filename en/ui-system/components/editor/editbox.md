...
To use `EditBox`, please refer to the [EditBox API](../../../api/en/classes/ui.editbox.html) documentation and the [editBox](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/12.editbox) scene of the test-cases-3d project.
