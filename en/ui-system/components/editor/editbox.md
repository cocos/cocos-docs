...
To use `EditBox`, please refer to the [EditBox API](https://docs.cocos.com/creator/3.4/api/en/#/docs/3.4/en/ui/Class/EditBox) documentation and the [EditBox](https://github.com/cocos-creator/test-cases-3d/tree/v3.4/assets/cases/ui/12.editbox) scene of the test-cases-3d project.
