...
To use `UIOpacity`, please refer to the [UIOpacity API](https://docs.cocos.com/creator/api/en/classes/ui.uiopacity.html) documentation and the [UIOpacity](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/other/opacity) scene of the test-cases-3d project.
