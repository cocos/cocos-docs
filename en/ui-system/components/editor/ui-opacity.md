...
To use `UIOpacity`, please refer to the [UIOpacity API](__APIDOC__/en/#/docs/3.3/en/ui/Class/UIOpacity) documentation and the [Opacity](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/ui/other/opacity) scene of the test-cases-3d project.
