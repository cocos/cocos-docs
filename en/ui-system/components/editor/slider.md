...
To use `Slider`, please refer to the [Slider API](__APIDOC__/en/#/docs/3.3/en/ui/Class/Slider) documentation and the [Slider](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/ui/10.slider) scene of the test-cases-3d project.
