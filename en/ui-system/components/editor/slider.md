...
To use `Slider`, please refer to the [Slider API](__APIDOC__/en/class/Slider) documentation and the [Slider](https://github.com/cocos-creator/test-cases-3d/tree/v3.5/assets/cases/ui/10.slider) scene of the test-cases-3d project.
