...
To use `PageView`, please refer to the [PageView API](__APIDOC__/en/classes/ui.pageviewindicator.html) documentation and the [PageView](https://github.com/cocos-creator/test-cases-3d/tree/v3.0/assets/cases/ui/15.pageview) scene of the test-cases-3d project.
