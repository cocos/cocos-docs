...
**Attention**: Starting from v1.9.1, points 1 and 2 are not recommended. If necessary please refer to [Custom Project Build Process](../../publish/custom-project-build-template.md).
