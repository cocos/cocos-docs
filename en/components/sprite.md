...
- `Tiled mode`: The image will be repeated to fit the size of the Sprite. If the SpriteFrame is [9-sliced](../ui/sliced-sprite.md), then the image is tiled, the corners will remain unscaled while the other sections be repeated.
