...
For the component interface of skeletal animation, please refer to the [SkeletalAnimation API](__APIDOC__/en/#/docs/3.5/en/animation/Class/SkeletalAnimation).
