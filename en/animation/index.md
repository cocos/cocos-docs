...
> The editor part has changed a lot since v1.9.2, and if you are using the Creator version v1.9.2 and later, please switch to another higher version of the manual in the upper right corner.
