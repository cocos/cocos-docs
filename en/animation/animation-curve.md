...
First, add an Animation Property Track and create two unequal keyframes on the track. For example, create two keyframes on the Animation Property Track `position`, from `(0, 0, 0)` to `(100, 100, 100)`, then a blue connecting line will appear between the two keyframes, double click the connecting line to open the curve editor, the default settings of the panel are as follows:
