...
| :-- | :-- |
| **ConnectedBody** | The rigid body at the other end of the joint connected <br> **Note**: In v3.7, if this property is not set, it will take the origin coordinates by default to be consistent with the implementation of the constraint in **3D Physics** |
